...
public class OrtaOyunEkraniMultiP extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_orta_oyun_ekrani_multi_p);
        imageButtonOrt1=findViewById(R.id.imageButtonortMulti1);
        imageButtonOrt2=findViewById(R.id.imageButtonortMulti2);
        imageButtonOrt3 = findViewById(R.id.imageButtonortMulti3);
        imageButtonOrt4 = findViewById(R.id.imageButtonortMulti4);
        imageButtonOrt5 = findViewById(R.id.imageButtonortMulti5);
        imageButtonOrt6 = findViewById(R.id.imageButtonortMulti6);
        imageButtonOrt7 = findViewById(R.id.imageButtonortMulti7);
        imageButtonOrt8 = findViewById(R.id.imageButtonortMulti8);
        imageButtonOrt9 = findViewById(R.id.imageButtonortMulti9);
        imageButtonOrt10 = findViewById(R.id.imageButtonortMulti10);
        imageButtonOrt11 = findViewById(R.id.imageButtonortMulti11);
        imageButtonOrt12 = findViewById(R.id.imageButtonortMulti12);
        imageButtonOrt13 = findViewById(R.id.imageButtonortMulti13);
        imageButtonOrt14 = findViewById(R.id.imageButtonortMulti14);
        imageButtonOrt15 = findViewById(R.id.imageButtonortMulti15);
        imageButtonOrt16 = findViewById(R.id.imageButtonortMulti16);
      oyuncuadi=findViewById(R.id.textoyuncuadıOrtaMp);


        Intent intent = getIntent();
        int milisec = intent.getIntExtra("milisec",0);
        txtTimer = findViewById(R.id.textViewsureOrtaMulti);
        ...
        ortaskor=findViewById(R.id.textViewortaSkorMulti);
        ...
        sesackapaorta=findViewById(R.id.buttonseskapaortaMulti);
                ...
                public void onClick(View view) {
                    ...
                    if (karşılaştırma.size()==2){
                        if(karşılaştırma.get(0).equals(karşılaştırma.get(1))){
                            ...
                            if(addegisikligisayac%2==0){
                                //settext oyuncu2
                                oyuncuadi.setText("Oynama Sırası: Oyuncu-2");

                            }else if(addegisikligisayac%2==1){
                                //settext oyuncu1
                                oyuncuadi.setText("Oynama Sırası: Oyuncu-1");
                            }
                            addegisikligisayac++;
                            sayac++;
