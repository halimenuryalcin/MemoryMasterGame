...
public class KolayOyunEkraniMultiP extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kolay_oyun_ekrani_multi_p);
        imageButtonKolay1=findViewById(R.id.imageButtonKolayMp1);
        imageButtonKolay2=findViewById(R.id.imageButtonKolayMp2);
        imageButtonKolay3=findViewById(R.id.imageButtonKolayMp3);
        imageButtonKolay4=findViewById(R.id.imageButtonKolayMp4);
        buttonseskapakolay=findViewById(R.id.buttonseskapakolayMulti);
        ...
        kolaySkor=findViewById(R.id.textViewKolaySkorMulti);
        oyuncuadi=findViewById(R.id.textoyuncuadıKolayMp);
        ...
        txtTimer=findViewById(R.id.textViewsurekolayMulti);
                    ...
                    if (karşılaştırma.size()==2){
                        if(karşılaştırma.get(0).equals(karşılaştırma.get(1))){
                            ...
                            if(asilList.get(finalI).getClass().equals(asilList.get(temp).getClass())){
                                skor=skor-(((asilList.get(finalI).getPuan()+asilList.get(temp).getPuan())/asilList.get(finalI).getKatsayi()));
                                ...
                                skor=skor-((((asilList.get(finalI).getPuan()+asilList.get(temp).getPuan())/2.0)*asilList.get(finalI).getKatsayi()*asilList.get(temp).getKatsayi()));
