package com.example.myapplication2.Multiplayer;
...
import com.example.myapplication2.kazandinizekran;
...
public class ZorOyunEkraniMultiP extends AppCompatActivity {

    TextView textoyuncuadi;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zor_oyun_ekrani_multi_p);
        imageButtonOrt1=findViewById(R.id.imageButtonzorMulti1);
        imageButtonOrt2=findViewById(R.id.imageButtonzorMulti2);
        imageButtonOrt3=findViewById(R.id.imageButtonzorMulti3);
        imageButtonOrt4=findViewById(R.id.imageButtonzorMulti4);
        imageButtonOrt5=findViewById(R.id.imageButtonzorMulti5);
        imageButtonOrt6=findViewById(R.id.imageButtonzorMulti6);
        imageButtonOrt7=findViewById(R.id.imageButtonzorMulti7);
        imageButtonOrt8=findViewById(R.id.imageButtonzorMulti8);
        imageButtonOrt9=findViewById(R.id.imageButtonzorMulti9);
        imageButtonOrt10=findViewById(R.id.imageButtonzorMulti10);
        imageButtonOrt11=findViewById(R.id.imageButtonzorMulti11);
        imageButtonOrt12=findViewById(R.id.imageButtonzorMulti12);
        imageButtonOrt13=findViewById(R.id.imageButtonzorMulti13);
        imageButtonOrt14=findViewById(R.id.imageButtonzorMulti14);
        imageButtonOrt15=findViewById(R.id.imageButtonzorMulti15);
        imageButtonOrt16=findViewById(R.id.imageButtonzorMulti16);
        imageButtonOrt17=findViewById(R.id.imageButtonzorMulti17);
        imageButtonOrt18=findViewById(R.id.imageButtonzorMulti18);
        imageButtonOrt19=findViewById(R.id.imageButtonzorMulti19);
        imageButtonOrt20=findViewById(R.id.imageButtonzorMulti20);
        imageButtonOrt21=findViewById(R.id.imageButtonzorMulti21);
        imageButtonOrt22=findViewById(R.id.imageButtonzorMulti22);
        imageButtonOrt23=findViewById(R.id.imageButtonzorMulti23);
        imageButtonOrt24=findViewById(R.id.imageButtonzorMulti24);
        imageButtonOrt25=findViewById(R.id.imageButtonzorMulti25);
        imageButtonOrt26=findViewById(R.id.imageButtonzorMulti26);
        imageButtonOrt27=findViewById(R.id.imageButtonzorMulti27);
        imageButtonOrt28=findViewById(R.id.imageButtonzorMulti28);
        imageButtonOrt29=findViewById(R.id.imageButtonzorMulti29);
        imageButtonOrt30=findViewById(R.id.imageButtonzorMulti30);
        imageButtonOrt31=findViewById(R.id.imageButtonzorMulti31);
        imageButtonOrt32=findViewById(R.id.imageButtonzorMulti32);
        imageButtonOrt33=findViewById(R.id.imageButtonzorMulti33);
        imageButtonOrt34=findViewById(R.id.imageButtonzorMulti34);
        imageButtonOrt35=findViewById(R.id.imageButtonzorMulti35);
        imageButtonOrt36=findViewById(R.id.imageButtonzorMulti36);
        play=MediaPlayer.create(this,R.raw.anamuzik);
        play.start();
        bulunduplay=MediaPlayer.create(this,R.raw.bulundu);
        sesackapazor=findViewById(R.id.sesackapazorMulti);
        skorzortext=findViewById(R.id.textViewskorzorMulti);
        textoyuncuadi=findViewById(R.id.textoyuncuadızorMp);
        ...
        txtTimer=findViewById(R.id.textViewzorsureZorMulti);
                ...
                public void onClick(View view) {
                    ...
                    if (karşılaştırma.size()==2){
                        if(karşılaştırma.get(0).equals(karşılaştırma.get(1))){
                            skor=skor+(2* imageList.get(finalI).getPuan()*imageList.get(finalI).getKatsayi());
                            ...
                            if(addegisikliksayac%2==0){
                                textoyuncuadi.setText("Oynama Sırası: Oyuncu-2");
                            }
                            else if(addegisikliksayac%2==1){
                                textoyuncuadi.setText("Oynama Sırası: Oyuncu-1");
                            }
                            addegisikliksayac++;
                            sayac++;
                            ...
                            if(imageList.get(finalI).getClass().equals(imageList.get(temp).getClass())){
                                skor=skor-(((imageList.get(finalI).getPuan()+imageList.get(temp).getPuan())/imageList.get(finalI).getKatsayi()));
                                ...
                                skor=skor-(((imageList.get(finalI).getPuan()+imageList.get(temp).getPuan())/2.0)*imageList.get(finalI).getKatsayi()*imageList.get(temp).getKatsayi());
